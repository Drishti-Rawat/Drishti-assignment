  ...
  return (
    <section className='min-h-screen overflow-hidden'>
        ...
        <div className='md:h-screen h-[90vh] relative custom_gradient flex justify-center items-center overflow-hidden '>
            ...
            <div ref={heroref} className=' z-20 text-center px-4 sm:px-10  max-w-3xl text-white leading-8  space-y-6'>
                <h2 className=' sm:text-4xl text-2xl md:text-5xl lg:text-6xl  font-extrabold'> Artificial Intelligence and <span className='text-amber-400'>Machine Learning</span> </h2>
                <p className='text-sm sm:text-base'> Harness the power of artificial intelligence and machine learning to drive innovation, automate processes, and unlock new insights.</p>
            </div>

            <div ref={heroimgref} className='absolute top-6 md:top-4 '>
                <Image src="/aibg.png" width={600} height={600} className='opacity-45 '/>
            </div>
    ...
    <div ref={featuresRef} className="py-24 flex flex-col justify-center items-center space-y-10 border-b border-b-gray-200  px-10">
      ...
      <div ref={whyUsRef} className="flex flex-col py-24 border-b border-b-slate-300  space-y-16 px-10">
        ...
        <div ref={teamRef} className="flex px-10 flex-col py-20 justify-center items-center space-y-14 relative">
