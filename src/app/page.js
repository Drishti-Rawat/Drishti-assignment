...
export default function Home() {
  ...
  const teamMembers = [
    {
      ...
      description:
        "Lead innovative app development projects, delivering user-friendly, high-performance applications tailored to specific client needs.",
      profile: "/ankit.jpg",
    },
    {
      name: "Mayank Bisht",
      role: "Team Executive",
      description:
        "Optimize app performance, integrate advanced features, and meticulously maintain code quality for superior user satisfaction.",
    ...
    },
    {
      ...
      description:
        "Design and develop mobile and web applications, ensuring seamless and engaging user experiences and robust functionality.",
  ...
  return (
    <section className=" bg-slate-50 text-black min-h-screen overflow-hidden ">
      ...
      <div
        ref={featuresRef}
        className="flex  flex-col justify-center items-center py-16 text-black  border-b border-b-gray-200 px-10 space-y-14"
      >
      ...
      <div
        ref={whyUsRef}
        className="  py-20 flex flex-col border-b border-b-gray-200  items-center justify-center px-10 "
      >
        ...
        <div className="flex lg:flex-row flex-col items-center justify-center   py-16  ">
          ...
          >
            {WhyUs && WhyUs.map((item,index) => <Card key={index} feature={item}></Card>)}
          </div>
        </div>
      </div>
      ...
      <div
        ref={teamRef}
        className=" relative  flex flex-col justify-center items-center px-10 py-20 overflow-hidden space-y-20"
      >
        <h2 className=" text-4xl z-20 self-center text-center font-bold tracking-wider underline underline-offset-8 decoration-amber-400">
          Our App Developers Team
        </h2>
