    ...
    <section className="min-h-screen overflow-hidden px-6 py-10  bg-gray-200 ">
        ...
        <div className="h-[80vh]  px-5 py-14 flex lg:flex-row flex-col space-x-5 justify-center items-center bg-cyan-700 rounded-3xl mt-10 ">
          <div ref={heroref} className="  text-white text-center leading-10">
            ...
            <h2 className="sm:text-5xl  text-2xl lg:text-6xl  font-extrabold tracking-wider  ">Drones & Robotics</h2>
          ...
          <div ref={heroimgref}>
            <Image src="/robotic-illustration.png" width={350} height={350}/>
          </div>
        </div>

        {/* features */}
        <div ref={featuresRef} className="flex flex-col justify-center items-center  border-b border-b-slate-300  py-20 space-y-10  ">
            <h2 className="text-4xl self-center text-center font-bold tracking-wider underline underline-offset-8 decoration-amber-500">Features</h2>
        ...
        <div ref={whyUsRef} className="flex flex-col py-24 border-b border-b-slate-300  space-y-16">
        ...
        <div className="flex  lg:flex-row flex-col justify-center items-center   ">
            ...
            <div ref={imageref}>
                <Image src="/whyRobotics.png" width={500} height={500}/>
            </div>

            <div ref={cardref} className="grid grid-cols-1 lg:grid-cols-2  gap-6 justify-center items-center">
                {
        ...
        <h2 className="text-4xl z-20 self-center text-center font-bold tracking-wider underline underline-offset-8 decoration-amber-500">Robotics & Drones Team</h2>
